                ...
                var pokemonOwners = new List<PokemonOwner>()
                {
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            {
                                new PokemonCategory { Category = new Category("Electric") }
                            },
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokemonCategories = new List<PokemonCategory>()
                            {
                                new PokemonCategory { Category = new Category("Water")}
                            },
                            Reviews = new List<Review>()
                            {
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            PokemonCategories = new List<PokemonCategory>()
                            {
                                new PokemonCategory { Category = new Category("Leaf")}
                            },
                            Reviews = new List<Review>()
                            {
